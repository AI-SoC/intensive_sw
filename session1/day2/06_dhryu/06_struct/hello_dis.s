...
00000000000011cc <main>:
    ...
    1218:	48 8d 3d 12 0e 00 00 	lea    0xe12(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    ...
    1232:	48 8d 3d 08 0e 00 00 	lea    0xe08(%rip),%rdi        # 2041 <_IO_stdin_used+0x41>
    ...
    1270:	48 8d 3d ba 0d 00 00 	lea    0xdba(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    ...
    12e2:	48 8d 3d bd 0d 00 00 	lea    0xdbd(%rip),%rdi        # 20a6 <_IO_stdin_used+0xa6>
    12e9:	b8 00 00 00 00       	mov    $0x0,%eax
    12ee:	e8 7d fd ff ff       	callq  1070 <printf@plt>
    12f3:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    12f7:	83 e0 7f             	and    $0x7f,%eax
    12fa:	88 45 f7             	mov    %al,-0x9(%rbp)
    ...
    130d:	48 8d 3d 92 0d 00 00 	lea    0xd92(%rip),%rdi        # 20a6 <_IO_stdin_used+0xa6>
    1314:	b8 00 00 00 00       	mov    $0x0,%eax
    1319:	e8 52 fd ff ff       	callq  1070 <printf@plt>
    131e:	0f b6 45 f6          	movzbl -0xa(%rbp),%eax
    1322:	83 c8 08             	or     $0x8,%eax
    1325:	88 45 f6             	mov    %al,-0xa(%rbp)
    1328:	0f b6 45 f6          	movzbl -0xa(%rbp),%eax
    132c:	0f b6 d0             	movzbl %al,%edx
    132f:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    1333:	0f b6 c0             	movzbl %al,%eax
    1336:	89 c6                	mov    %eax,%esi
    1338:	48 8d 3d 67 0d 00 00 	lea    0xd67(%rip),%rdi        # 20a6 <_IO_stdin_used+0xa6>
    133f:	b8 00 00 00 00       	mov    $0x0,%eax
    1344:	e8 27 fd ff ff       	callq  1070 <printf@plt>
    1349:	b8 00 00 00 00       	mov    $0x0,%eax
    134e:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1352:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1359:	00 00 
    135b:	74 05                	je     1362 <main+0x196>
    135d:	e8 fe fc ff ff       	callq  1060 <__stack_chk_fail@plt>
    1362:	c9                   	leaveq 
    1363:	c3                   	retq   
...
0000000000001370 <__libc_csu_init>:
    ...
    1374:	41 57                	push   %r15
    1376:	4c 8d 3d 33 2a 00 00 	lea    0x2a33(%rip),%r15        # 3db0 <__frame_dummy_init_array_entry>
    137d:	41 56                	push   %r14
    ...
    138c:	55                   	push   %rbp
    138d:	48 8d 2d 24 2a 00 00 	lea    0x2a24(%rip),%rbp        # 3db8 <__do_global_dtors_aux_fini_array_entry>
    1394:	53                   	push   %rbx
