...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d ed 00 00 00 	lea    0xed(%rip),%rdi        # 1195 <main>
...
0000000000001169 <ADC_EOC_CHECK>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	55                   	push   %rbp
    116e:	48 89 e5             	mov    %rsp,%rbp
    1171:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    1178:	eb 0b                	jmp    1185 <ADC_EOC_CHECK+0x1c>
    117a:	c7 45 fc 0a 00 00 00 	movl   $0xa,-0x4(%rbp)
    1181:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    1185:	81 7d f8 9f 86 01 00 	cmpl   $0x1869f,-0x8(%rbp)
    118c:	7e ec                	jle    117a <ADC_EOC_CHECK+0x11>
...
0000000000001195 <main>:
    ...
    11a8:	e8 b3 fe ff ff       	callq  1060 <puts@plt>
    11ad:	c7 45 f8 03 00 00 00 	movl   $0x3,-0x8(%rbp)
    11b4:	90                   	nop
    11b5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ba:	e8 aa ff ff ff       	callq  1169 <ADC_EOC_CHECK>
    11bf:	85 c0                	test   %eax,%eax
    11c1:	74 f2                	je     11b5 <main+0x20>
    11c3:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11c6:	83 c0 07             	add    $0x7,%eax
    11c9:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11cc:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11cf:	89 c6                	mov    %eax,%esi
    11d1:	48 8d 3d 39 0e 00 00 	lea    0xe39(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
