...
0000000000001060 <_start>:
    ...
    1071:	50                   	push   %rax
    1072:	54                   	push   %rsp
    1073:	4c 8d 05 b6 01 00 00 	lea    0x1b6(%rip),%r8        # 1230 <__libc_csu_fini>
    107a:	48 8d 0d 3f 01 00 00 	lea    0x13f(%rip),%rcx        # 11c0 <__libc_csu_init>
    1081:	48 8d 3d ed 00 00 00 	lea    0xed(%rip),%rdi        # 1175 <main>
...
0000000000001149 <ADC_EOC_CHECK>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	55                   	push   %rbp
    114e:	48 89 e5             	mov    %rsp,%rbp
    1151:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    1158:	eb 0b                	jmp    1165 <ADC_EOC_CHECK+0x1c>
    115a:	c7 45 fc 0a 00 00 00 	movl   $0xa,-0x4(%rbp)
    1161:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    1165:	81 7d f8 9f 86 01 00 	cmpl   $0x1869f,-0x8(%rbp)
    116c:	7e ec                	jle    115a <ADC_EOC_CHECK+0x11>
...
0000000000001175 <main>:
    ...
    1181:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    1188:	90                   	nop
    1189:	b8 00 00 00 00       	mov    $0x0,%eax
    118e:	e8 b6 ff ff ff       	callq  1149 <ADC_EOC_CHECK>
    1193:	85 c0                	test   %eax,%eax
    1195:	74 f2                	je     1189 <main+0x14>
    1197:	8b 45 f8             	mov    -0x8(%rbp),%eax
    119a:	83 c0 14             	add    $0x14,%eax
    119d:	89 45 fc             	mov    %eax,-0x4(%rbp)
    ...
    11b1:	e8 9a fe ff ff       	callq  1050 <printf@plt>
