...
void initERU_SW1(void);


__interrupt(0x0A) __vector_table(0)
void ERU0_ISR(void)
{
    P10_OUT.B.P1 ^= 0x1;  // toggle P10.1 (LED D12 RED)
}
...
void ERU1_ISR(void)
{
    P10_OUT.B.P2 ^= 0x1;  // toggle P10.2 (LED D13 BLUE)
}
...
void initERU_SW1(void)
{
    ...
    SCU_EICR1.B.FEN1  = 0x1;
    SCU_EICR1.B.EIEN1 = 0x1;
    SCU_EICR1.B.INP1  = 0x1;

    SCU_IGCR0.B.IGP1  = 0x1;     // OGU1 -> SCUERU1
