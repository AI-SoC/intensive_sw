...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        if( adcResult >= 3096 )
        {
            GTM_TOM0_CH1_SR1.U = 0; // LED Red

            GTM_TOM0_CH2_SR1.U  = 12500;
            GTM_TOM0_CH3_SR1.U  = 12500;
            GTM_TOM0_CH15_SR1.U = 1;
        }
        else if( adcResult >= 2048 )
        {
            GTM_TOM0_CH1_SR1.U = 1000; // LED Red

            GTM_TOM0_CH2_SR1.U  = 12500;
            GTM_TOM0_CH3_SR1.U  = 1;
            GTM_TOM0_CH15_SR1.U = 12500;
        }
        else if( adcResult >= 1024 )
        {
            GTM_TOM0_CH1_SR1.U = 7000; // LED Red
        ...
        {
            GTM_TOM0_CH1_SR1.U = 12500; // LED Red

            GTM_TOM0_CH2_SR1.U  = 6000;
            GTM_TOM0_CH3_SR1.U  = 6000;
            GTM_TOM0_CH15_SR1.U = 6000;
        }
...
void initGTM(void)
{
    ...
    GTM_TOM0_CH2_CTRL.U |= 0x1 << CLK_SRC_SR_BIT_LSB_IDX;           // clock source --> CMU_FXCLK(1) = 3125 kHz

    GTM_TOM0_CH2_SR0.U = 12500 - 1;                             // PWM freq. = 3125 kHz / 12500 = 250 kHz
    ...
    GTM_TOM0_CH3_CTRL.U |= 0x1 << CLK_SRC_SR_BIT_LSB_IDX;           // clock source --> CMU_FXCLK(1) = 3125 kHz

    GTM_TOM0_CH3_SR0.U = 12500 - 1;                             // PWM freq. = 3125 kHz / 12500 = 250 kHz
    //GTM_TOM0_CH3_SR1.U = 125 - 1;                              // duty cycle = 6250 / 12500 = 50 %

    // TOM 0_15
    GTM_TOM0_CH15_CTRL.B.SL |= 0x1;                 // high signal level for duty cycle
    GTM_TOM0_CH15_CTRL.B.CLK_SRC_SR |= 0x1;           // clock source --> CMU_FXCLK(1) = 3125 kHz

    GTM_TOM0_CH15_SR0.U = 12500 - 1;                             // PWM freq. = 3125 kHz / 12500 = 250 kHz
