...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        P10_OUT.U ^= 0x1 << P2_BIT_LSB_IDX; // toggle P10.2 (LED D12 BLUE)
        */
        /*
        // 2. GPIO IN
        ...
        // the cycle is too fast
        */
        /*
        // 2-1. GPIO IN (check 3 times)
        ...
        if (a == 0 && b == 0 && c == 0)
            ...
            P10_OUT.U &= ~(0x1 << P1_BIT_LSB_IDX); // clear P10.1 (LED D13 RED)
        */
        // 2-2. GPIO IN (edge detection)
        prev = P02_IN.U & (0x1 << P1_BIT_LSB_IDX);
